...
def main():
    ...
    # print(imgs_out.data_ptr)
    # z = MyMul.apply(imgs_in, imgs_in, imgs_out)
    # print(imgs_out.data_ptr)
    # print(z.data_ptr)


    print(imgs_out.data_ptr)
    print(imgs_in.data_ptr)
    imgs_out = f((weight_map, kernel_map, imgs_in))
    print(imgs_out.data_ptr)
    print(imgs_in.data_ptr)
    print(weight_map.requires_grad)
    print(kernel_map.requires_grad)
